namespace HW3.Net
{
    ...
    public class Task3
    {
        ...
        public List<string> RandomListGeneration()
        {
            List<string> strings = new List<string>();
            for (int i = 0; i < random.Next(100, 999); i++)
            {
                strings.Add(RandomStringGeneration());
            }
        ...
        public List<string> DeleteRepeats(List<string> strings)
        {
            return new List<string>(new HashSet<string>(strings));
        }

        public List<string> DeleteWhereZ(List<string> strings)
        {
